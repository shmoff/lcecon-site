...
| `assets/js/cso-pie.js` | `CsoPie` donut engine with year slider: data-driven top-N + "Other" slices, legend with shares, hover, themed PNG export. Used for tax revenue (ITXS01) and social protection (SPEA02). |
